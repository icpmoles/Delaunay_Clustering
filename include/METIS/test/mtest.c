...
void Test_PartGraph(idx_t nvtxs, idx_t* xadj, idx_t* adjncy)
{
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphRecursive(&nvtxs, xadj, adjncy, NULL, NULL, &wgtflag, &numflag, &nparts, options, &edgecut, part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphRecursive(&nvtxs, xadj, adjncy, NULL, adjwgt, &wgtflag, &numflag, &nparts, options, &edgecut, part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphRecursive(&nvtxs, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, options, &edgecut, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphRecursive(&nvtxs, xadj, adjncy, NULL, NULL, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut,
                            part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphRecursive(&nvtxs, xadj, adjncy, NULL, adjwgt, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut,
                            part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphRecursive(&nvtxs, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut,
                            part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphKway(&nvtxs, xadj, adjncy, NULL, adjwgt, &wgtflag, &numflag, &nparts, options, &edgecut, part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphKway(&nvtxs, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, options, &edgecut, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphKway(&nvtxs, xadj, adjncy, NULL, NULL, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphKway(&nvtxs, xadj, adjncy, NULL, adjwgt, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut,
                       part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphKway(&nvtxs, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphKway(&nvtxs, xadj, adjncy, vwgt, adjwgt, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut,
                       part);
 ...
 **************************************************************************/
int VerifyPart(idx_t nvtxs, idx_t* xadj, idx_t* adjncy, idx_t* vwgt, idx_t* adjwgt, idx_t nparts, idx_t edgecut,
               idx_t* part)
{
 ...
 * This function verifies that the partitioning was computed correctly
 **************************************************************************/
int VerifyWPart(idx_t nvtxs, idx_t* xadj, idx_t* adjncy, idx_t* vwgt, idx_t* adjwgt, idx_t nparts, real_t* tpwgts,
...
void Test_PartGraphV(idx_t nvtxs, idx_t* xadj, idx_t* adjncy)
{
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphVKway(&nvtxs, xadj, adjncy, NULL, NULL, &wgtflag, &numflag, &nparts, options, &totalv, part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphVKway(&nvtxs, xadj, adjncy, NULL, vsize, &wgtflag, &numflag, &nparts, options, &totalv, part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphVKway(&nvtxs, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, options, &totalv, part);
  ...
  nparts = 20;
  options[0] = 0;
  METIS_PartGraphVKway(&nvtxs, xadj, adjncy, vwgt, vsize, &wgtflag, &numflag, &nparts, options, &totalv, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphVKway(&nvtxs, xadj, adjncy, NULL, NULL, &wgtflag, &numflag, &nparts, tpwgts, options, &totalv, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphVKway(&nvtxs, xadj, adjncy, NULL, vsize, &wgtflag, &numflag, &nparts, tpwgts, options, &totalv, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphVKway(&nvtxs, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, tpwgts, options, &totalv, part);
  ...
  nparts = 6;
  options[0] = 0;
  METIS_WPartGraphVKway(&nvtxs, xadj, adjncy, vwgt, vsize, &wgtflag, &numflag, &nparts, tpwgts, options, &totalv, part);
 ...
 * This function verifies that the partitioning was computed correctly
 **************************************************************************/
int VerifyPartV(idx_t nvtxs, idx_t* xadj, idx_t* adjncy, idx_t* vwgt, idx_t* vsize, idx_t nparts, idx_t totalv,
                idx_t* part)
{
 ...
 * This function verifies that the partitioning was computed correctly
 **************************************************************************/
int VerifyWPartV(idx_t nvtxs, idx_t* xadj, idx_t* adjncy, idx_t* vwgt, idx_t* vsize, idx_t nparts, real_t* tpwgts,
                 idx_t totalv, idx_t* part)
{
...
void Test_PartGraphmC(idx_t nvtxs, idx_t* xadj, idx_t* adjncy)
{
  ...
  ubvec[2] = 1.05;
  options[0] = 0;
  METIS_mCPartGraphRecursive(&nvtxs, &ncon, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, options, &edgecut,
                             part);
  ...
  ubvec[2] = 1.05;
  options[0] = 0;
  METIS_mCPartGraphKway(&nvtxs, &ncon, xadj, adjncy, vwgt, NULL, &wgtflag, &numflag, &nparts, ubvec, options, &edgecut,
                        part);
  ...
  ubvec[2] = 1.05;
  options[0] = 0;
  METIS_mCPartGraphKway(&nvtxs, &ncon, xadj, adjncy, vwgt, adjwgt, &wgtflag, &numflag, &nparts, ubvec, options,
                        &edgecut, part);
 ...
 * This function verifies that the partitioning was computed correctly
 **************************************************************************/
int VerifyPartmC(idx_t nvtxs, idx_t ncon, idx_t* xadj, idx_t* adjncy, idx_t* vwgt, idx_t* adjwgt, idx_t nparts,
