...
#define GK_MKPQUEUE2(FPRFX, PQT, KT, VT, KMALLOC, VMALLOC, KMAX, KEY_LT)                                               \
  ...
  /**************************************************************************/                                         \
  void FPRFX##Reset2(PQT* queue) { queue->nnodes = 0; }                                                                \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
  ...
  /**************************************************************************/                                         \
  size_t FPRFX##Length2(PQT* queue) { return queue->nnodes; }                                                          \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
  ...
  /*! This function returns the key of the top item. The item is not                                                   \
      deleted from the queue. */                                                                                       \
  /**************************************************************************/                                         \
  KT FPRFX##SeeTopKey2(PQT* queue) { return (queue->nnodes == 0 ? KMAX : queue->keys[0]); }                            \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
