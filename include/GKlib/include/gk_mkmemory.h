...
#define GK_MKALLOC(PRFX, TYPE)                                                                                         \
  ...
  /**************************************************************************/                                         \
  TYPE* PRFX##malloc(size_t n, char* msg) { return (TYPE*)gk_malloc(sizeof(TYPE) * n, msg); }                          \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
  /*! The macro for gk_?realloc()-class of routines */                                                                 \
  /**************************************************************************/                                         \
  TYPE* PRFX##realloc(TYPE* ptr, size_t n, char* msg) { return (TYPE*)gk_realloc((void*)ptr, sizeof(TYPE) * n, msg); } \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
  ...
  /*! The macro for gk_?set()-class of routines */                                                                     \
  /*************************************************************************/                                          \
  TYPE* PRFX##copy(size_t n, TYPE* a, TYPE* b) { return (TYPE*)memmove((void*)b, (void*)a, sizeof(TYPE) * n); }        \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
