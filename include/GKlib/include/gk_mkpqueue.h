...
#define GK_MKPQUEUE(FPRFX, PQT, KVT, KT, VT, KVMALLOC, KMAX, KEY_LT)                                                   \
  ...
  /**************************************************************************/                                         \
  size_t FPRFX##Length(PQT* queue) { return queue->nnodes; }                                                           \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
  ...
  /**************************************************************************/                                         \
  VT FPRFX##SeeTopVal(PQT* queue) { return (queue->nnodes == 0 ? -1 : queue->heap[0].val); }                           \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
  /*! This function returns the key of the top item. The item is not                                                   \
      deleted from the queue. */                                                                                       \
  /**************************************************************************/                                         \
  KT FPRFX##SeeTopKey(PQT* queue) { return (queue->nnodes == 0 ? KMAX : queue->heap[0].key); }                         \
                                                                                                                       \
                                                                                                                       \
  /*************************************************************************/                                          \
