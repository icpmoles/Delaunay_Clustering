...
void gk_mcoreDestroy(gk_mcore_t** r_mcore, int showstats)
{
  ...
  if(showstats)
    printf("\n gk_mcore statistics\n"
           ...
           mcore->coresize, mcore->nmops, mcore->cmop, mcore->num_callocs, mcore->num_hallocs, mcore->size_callocs,
           mcore->size_hallocs, mcore->cur_callocs, mcore->cur_hallocs, mcore->max_callocs, mcore->max_hallocs);
