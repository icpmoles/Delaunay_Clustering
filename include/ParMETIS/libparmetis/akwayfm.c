  ...
  for(pass = 0; pass < npasses; pass++)
  {
    ...
    for(c = 0; c < 2; c++)
    {
      ...
      for(iii = 0; iii < nvtxs; iii++)
      {
        ...
        if(gain > 0.0 ||
           (gain > -1.0 * SMALLFLOAT && (imbalanced || graph->level > 3 || iii % 8 == 0) &&
      ...
      IFSET(ctrl->dbglvl, DBG_RMOVEINFO,
            rprintf(ctrl,
                    ...
                    pass, c, badmaxpwgt[0], GlobalSESum(ctrl, nmoved), GlobalSESum(ctrl, nmoves),
