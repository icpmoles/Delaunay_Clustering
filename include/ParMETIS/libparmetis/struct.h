...
typedef struct graph_t
{
  ...
  idx_t *pexadj, *peadjncy, *peadjloc; /*!< CSR format of the PEs each vertex is adjancent to
...
typedef struct ctrl_t
{
  ...
  /* Various Timers */
  timer TotalTmr, InitPartTmr, MatchTmr, ContractTmr, CoarsenTmr, RefTmr, SetupTmr, ProjectTmr, KWayInitTmr, KWayTmr,
    MoveTmr, RemapTmr, SerialTmr, AuxTmr1, AuxTmr2, AuxTmr3, AuxTmr4, AuxTmr5, AuxTmr6;
} ctrl_t;
