                           ...
                           real_t* flows, idx_t* from, idx_t* qnum, idx_t minval, real_t avgvwgt, real_t maxdiff)
{
  ...
  *qnum = -1;
  ...
  case 4:
    ...
    if(dont_cares[0] == 2 && dont_cares[1] == 0 && dont_cares[2] == 1 && dont_cares[3] == 1)
    {
      nperms = 14;
      perm[0][0] = 0;
      perm[0][1] = 1;
    ...
    if(dont_cares[0] == 1 && dont_cares[1] == 1 && dont_cares[2] == 2 && dont_cares[3] == 0)
    {
      nperms = 14;
      perm[0][0] = 0;
      perm[0][1] = 1;
    ...
    if(dont_cares[0] == 2 && dont_cares[1] == 0 && dont_cares[2] == 2 && dont_cares[3] == 0)
    {
      nperms = 14;
      perm[0][0] = 0;
      perm[0][1] = 1;
    ...
    if(dont_cares[0] == 3 && dont_cares[1] == 0 && dont_cares[2] == 0 && dont_cares[3] == 1)
    {
      nperms = 14;
      perm[0][0] = 0;
      perm[0][1] = 1;
    ...
    if(dont_cares[0] == 1 && dont_cares[1] == 3 && dont_cares[2] == 0 && dont_cares[3] == 0)
    {
      nperms = 14;
      perm[0][0] = 0;
      perm[0][1] = 1;
