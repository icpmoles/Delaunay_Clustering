                    ...
                    idx_t* adjwgt, idx_t wgtflag)
{
  ...
  if(ctrl->optype == PARMETIS_OP_AMETIS || ctrl->optype == PARMETIS_OP_RMETIS)
  {
    ...
    ctrl->edge_size_ratio = (.1 + (real_t)GlobalSESum(ctrl, isum(graph->nedges, graph->adjwgt, 1))) /
...
void FreeGraph(graph_t* graph)
{
  ...
  gk_free((void**)&graph->xadj, (void**)&graph->vwgt, (void**)&graph->nvwgt, (void**)&graph->vsize,
          (void**)&graph->adjncy, (void**)&graph->adjwgt, (void**)&graph->vtxdist, (void**)&graph->home, LTERM);
...
void FreeNonGraphFields(graph_t* graph)
{
  ...
  gk_free(
    /* Coarsening fields */
    (void**)&graph->match, (void**)&graph->cmap,

    /* Initial partitioning fields */
    (void**)&graph->label,

    /* Communication/Setup fields */
    (void**)&graph->peind, (void**)&graph->sendptr, (void**)&graph->sendind, (void**)&graph->recvptr,
    (void**)&graph->recvind, (void**)&graph->imap, (void**)&graph->pexadj, (void**)&graph->peadjncy,
    (void**)&graph->peadjloc, (void**)&graph->lperm,

    /* Projection fields */
    (void**)&graph->rlens, (void**)&graph->slens, (void**)&graph->rcand,

    /* Refinement fields */
    (void**)&graph->where, (void**)&graph->lpwgts, (void**)&graph->gpwgts, (void**)&graph->lnpwgts,
    (void**)&graph->gnpwgts, (void**)&graph->ckrinfo, (void**)&graph->nrinfo, (void**)&graph->sepind,
...
void FreeCommSetupFields(graph_t* graph)
{
  ...
  gk_free(
    /* Communication/Setup fields */
    (void**)&graph->lperm, (void**)&graph->peind, (void**)&graph->sendptr, (void**)&graph->sendind,
    (void**)&graph->recvptr, (void**)&graph->recvind, (void**)&graph->imap, (void**)&graph->pexadj,
    (void**)&graph->peadjncy, (void**)&graph->peadjloc,
