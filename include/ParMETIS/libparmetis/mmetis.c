 ...
 ************************************************************************************/
int ParMETIS_V3_PartMeshKway(idx_t* elmdist, idx_t* eptr, idx_t* eind, idx_t* elmwgt, idx_t* wgtflag, idx_t* numflag,
                             ...
                             idx_t* edgecut, idx_t* part, MPI_Comm* comm)
{
  ...
  status = CheckInputsPartMeshKway(elmdist, eptr, eind, elmwgt, wgtflag, numflag, ncon, ncommon, nparts, tpwgts, ubvec,
  ...
  status = ParMETIS_V3_PartKway(elmdist, xadj, adjncy, elmwgt, NULL, wgtflag, numflag, ncon, nparts, tpwgts, ubvec,
                                options, edgecut, part, &(ctrl->comm));
